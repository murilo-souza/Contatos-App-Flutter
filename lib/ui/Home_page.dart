                  ...
                  child:  Column(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.all(10.0),
                        child:FlatButton(
                          child: Text("Ligar", style: TextStyle(color: Colors.greenAccent, fontSize: 20.0),
                          ),
                          onPressed: (){
                      ...
                      Padding(
                        padding: EdgeInsets.all(10.0),
                        child:FlatButton(
                          child: Text("Editar", style: TextStyle(color: Colors.amberAccent, fontSize: 20.0),
                          ),
                          onPressed: (){
                            Navigator.pop(context);
                      ...
                      Padding(
                        padding: EdgeInsets.all(10.0),
                        child:FlatButton(
                          child: Text("Excluir", style: TextStyle(color: Colors.redAccent, fontSize: 20.0),
                          ),
                          onPressed: (){
